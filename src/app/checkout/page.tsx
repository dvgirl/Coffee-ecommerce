...
export default function CheckoutPage() {
  ...
  const processOrder = () => {
    ...
    const options = {
      ...
      currency: "USD",
      name: "Aura Coffee",
      description: "Premium Artisan Roast Order",
      image: "https://cdn.lucide.com/icons/coffee.svg",
    ...
    <div className="pt-32 pb-24 px-6 md:px-12 container mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 max-w-7xl mx-auto">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-4xl font-serif font-bold mb-10 text-foreground">Checkout</h1>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="bg-black/5 p-8 rounded-3xl border border-black/5 flex flex-col gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted leading-relaxed">{formData.address}, {formData.city}, {formData.zip}</p>
                        </div>
                      </div>
